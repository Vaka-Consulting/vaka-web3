...
// import { acceptJson } from '@vakaconsulting/web3-auth'
import { AuthContextProvider, WalletContextProvider, WalletExtendedContextProvider } from '@vakaconsulting/react'
